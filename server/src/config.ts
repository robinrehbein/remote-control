...
const DEFAULT_NETWORK_ALLOWLIST = [
  ...
  'open.bigmodel.cn',
  'api.z.ai',
  // kilo (an OpenCode fork) builds its provider/model catalog from
  // models.dev/api.json at startup; blocked, GET /config/providers answers
  // with an empty list and the app has no models to offer for that adapter.
